...
private struct ThemeTile: View {
    ...
    var body: some View {
        VStack(spacing: 6) {
            ...
            Text(LocalizedStringKey(preference.description))
        ...
        .accessibilityLabel(Text(LocalizedStringKey(preference.description)))
    }
}
...
private struct PopupSizeTile: View {
    ...
    var body: some View {
        VStack(spacing: 6) {
            ...
            Text(LocalizedStringKey(size.description))
                .font(.system(size: 11, weight: isSelected ? .semibold : .regular))
                .foregroundStyle(isSelected ? .primary : .secondary)
        }
        .contentShape(Rectangle())
        ...
        .accessibilityElement(children: .combine)
        .accessibilityAddTraits(isSelected ? [.isButton, .isSelected] : .isButton)
        .accessibilityLabel(Text(LocalizedStringKey(size.description)))
    }
}
