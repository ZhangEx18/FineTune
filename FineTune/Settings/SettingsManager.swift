...
nonisolated struct AppSettings: Codable, Equatable {
    ...
    var autoSwitchNewHeadphoneOutput: Bool = true // Make newly connected headphone-like outputs default
    ...
    init(from decoder: Decoder) throws {
        ...
        autoSwitchNewHeadphoneOutput = try c.decodeIfPresent(Bool.self, forKey: .autoSwitchNewHeadphoneOutput) ?? true
